...
import svgPaths from "./svg-tvlh52avst";
...
export default function Ribbon() {
  return (
    <a className="block cursor-pointer relative size-full" data-name="Ribbon" href="https://codepen.io/RobotsPlay/pen/MagEeO">
      ...
      <div className="absolute flex h-[55.929px] items-center justify-center left-[20.17px] top-[73.28px] w-[95.138px]" style={{ "--transform-inner-width": "1200", "--transform-inner-height": "21" } as React.CSSProperties}>
        <RibbonHelper additionalClassNames="rotate-[-25.96deg]">OUR MEMBERS!</RibbonHelper>
      </div>
    </a>
  );
}